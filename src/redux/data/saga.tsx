...
import { IFavouritePlaceReq, IPostFavouritePlaceOutput } from "../../utils/interfaces"


function* dataSaga(
   action: PayloadAction<IFavouritePlaceReq>,
): Generator<Effect, void> {
   const res = (yield call(postFavouritePlace, action.payload)) as IPostFavouritePlaceOutput;
